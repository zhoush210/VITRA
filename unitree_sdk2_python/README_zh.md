...
cd ~/cyclonedds/build
# 看看 idlc 正在用哪个库
ldd ../bin/idlc | grep -E 'ddsc|cyclonedds'
...
cd /home/shihuiz/VITRA/unitree_sdk2_python
pip install -e .

python /home/shihuiz/VITRA/unitree_sdk2_python/example/g1/high_level/test_act.py
